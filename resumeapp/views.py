...
def createResume(request):
    if request.method == "POST":
        ...
        mygraduatecollegequalification = request.POST.get(
            'graduatecollegequalification')
        ...
        r = Resume(name=myname, age=myage, emailid=myemail, gender=mygender, phoneno=myphone,
                   ...
                   schoolduration=myschoolduration, collegename=mycollegename, collegequalification=mycollegequalification,
                   collegeduration=mycollegeduration, graduatedcollegename=mygraduatecollegename,
                   graduatequalification=mygraduatecollegequalification, graduateduration=mygraduatecollegeduration,
